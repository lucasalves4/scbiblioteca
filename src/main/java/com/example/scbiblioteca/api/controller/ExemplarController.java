...
//    @PostMapping()
//    public ResponseEntity post(ExemplarDTO dto) {
//        try {
...
//
//    @PutMapping("{id}")
//    public ResponseEntity atualizar(@PathVariable("id") Long id, ExemplarDTO dto) {
...
//                exemplar.setReserva(null);
//            } else {
//                exemplar.setReserva(reserva.get());
//            }
//        }
//        return exemplar;
//    }
